...
class WeatherHistory(Base):
    ...
    weather_code: Mapped[str | None] = mapped_column(String(16), nullable=True, index=True)  # 天气编码
    ...
    is_forecast: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)  # 预报 or 实测
